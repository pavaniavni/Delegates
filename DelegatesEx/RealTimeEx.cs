...
namespace DelegatesEx
{
    ...
    internal class RealTimeExample
    {
        ...
        {
            Employee employee1 = new Employee() { ID = 101, Name = "pavani 1", Gender = "Male", Experience = 10, Salary = 10000 };
            Employee employee2 = new Employee() { ID = 102, Name = "pavani 2", Gender = "Male", Experience = 10, Salary = 70000 };
            Employee employee3 = new Employee() { ID = 103, Name = "pavani 3", Gender = "Male", Experience = 10, Salary = 30000 };
